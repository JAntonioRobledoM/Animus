                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="w-full bg-abstergo-dark/70 border border-abstergo-blue/40 rounded py-2 px-3 text-white" value="{{ old('title') }}" required>
                        </div>
                        
                        <div class="mb-4">
                            <label for="subtitle" class="block text-abstergo-light-blue mb-2">Subtítulo</label>
                            <input type="text" name="subtitle" id="subtitle" class="w-full bg-abstergo-dark/70 border border-abstergo-blue/40 rounded py-2 px-3 text-white" value="{{ old('subtitle') }}">
                        </div>
                        
                        <div class="mb-4">
                            <label for="position" class="block text-abstergo-light-blue mb-2">Posición</label>
                            <input type="number" name="position" id="position" class="w-full bg-abstergo-dark/70 border border-abstergo-blue/40 rounded py-2 px-3 text-white" value="{{ old('position') }}" placeholder="Se asignará automáticamente si se deja vacío">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="path" id="path" class="w-full bg-abstergo-dark/70 border border-abstergo-blue/40 rounded py-2 px-3 text-white" value="{{ old('path') }}" placeholder="C:\Juegos\AssassinsCreed\AC.exe">
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-gray-400 mt-1">Formatos aceptados: JPG, PNG, GIF. Tamaño máximo: 2MB.</p>
                        </div>
                        
                        <div class="mb-4">
                            <label class="block text-abstergo-light-blue mb-2">Vista previa de imagen</label>
                            <div class="border border-dashed border-abstergo-blue/40 rounded h-40 flex items-center justify-center" id="imagePreview">
                                <span class="text-gray-400">No se ha seleccionado ninguna imagen</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.getElementById('img').addEventListener('change', function(e) {
            ...
            if (this.files && this.files[0]) {
                ...
                preview.innerHTML = '<span class="text-gray-400">No se ha seleccionado ninguna imagen</span>';
            }
        });
    </script>
</body>
